...
| [NAVIGATION_VALUE.md](NAVIGATION_VALUE.md) | Whether exploration reads target what a symbol tool could answer: the #114 phase-3 gate, its pre-registered decision rule, and the HALT it returned (2026-09-10) |
